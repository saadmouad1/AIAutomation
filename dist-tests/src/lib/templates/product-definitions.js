...
exports.PRODUCT_CATEGORIES = exports.AUTOMATION_PRODUCTS = void 0;
...
const missedCallRecovery = {
    ...
    heroDescription: "When your business misses a call, Flowra instantly sends a personalized SMS or WhatsApp message to the caller — so you never lose a lead again.",
    shortDescription: "Automatically follow up with customers when you miss their call. AI writes the message for you.",
    longDescription: "Every missed call is a potential customer walking out the door. Flowra intercepts missed and unanswered calls from Twilio, generates a warm AI-personalized response, and sends it via SMS or WhatsApp — all within seconds of the missed call.",
    category: "Customer Support",
    icon: "PhoneMissed",
    color: "#635BFF",
    targetCustomer: ["Clinics", "Salons", "Auto Repair", "Real Estate", "Local Services"],
    problem: "Every missed call is a potential customer who might call your competitor next.",
    problemPoints: [
    ...
    solution: "Flowra listens for missed calls and automatically sends a personalized follow-up within seconds.",
    workflowSteps: [
    ...
    faqs: [
        {
            ...
            answer: "Twilio sends a webhook to Flowra when a call is not answered (status: no-answer or busy). Flowra then triggers the automation.",
        },
        {
            question: "Do I need a Twilio number?",
            answer: "Yes. You need a Twilio phone number that handles your business calls. Setup takes about 10 minutes.",
        },
        {
            question: "Can I customize the message?",
            answer: "Yes. You can provide your business name and tone. AI generates the personalized message dynamically.",
        },
        {
            question: "Does it work with WhatsApp?",
            answer: "Yes. With a Twilio WhatsApp sandbox or approved number, messages can be sent via WhatsApp.",
        },
    ],
...
const aiLeadQualification = {
    ...
    heroDescription: "Flowra's AI analyzes every incoming lead, scores them 0–100, and classifies them as Hot, Warm, or Cold — so your sales team focuses on the best opportunities.",
    shortDescription: "AI scores and classifies every new lead so your team focuses on the right prospects.",
    longDescription: "When a lead submits a form or enters your CRM, Flowra extracts their information, runs AI analysis to determine intent and buying signals, scores them from 0 to 100, and classifies them as Hot, Warm, or Cold with a recommended action.",
    category: "Sales",
    icon: "Target",
    color: "#06B6D4",
    ...
    solution: "AI analyzes each lead's intent, behavior, and signals to score and prioritize automatically.",
    workflowSteps: [
...
const reviewReputation = {
    ...
    heroDescription: "After every service, Flowra automatically asks for feedback, analyzes sentiment, and guides satisfied customers to leave a review — while routing complaints directly to you.",
    shortDescription: "Automatically collect feedback and turn happy customers into online reviews.",
    longDescription: "After a service is completed, Flowra sends a feedback request via SMS or WhatsApp. AI analyzes the sentiment. If positive, the customer is guided to leave a Google/Trustpilot review. If negative, the business owner is notified immediately for damage control.",
    category: "Marketing",
    icon: "Star",
    color: "#F59E0B",
    ...
    solution: "Automatically collect feedback, route it intelligently, and invite happy customers to leave public reviews.",
    workflowSteps: [
...
const leadFollowUp = {
    ...
    heroDescription: "The first business to respond wins. Flowra sends an immediate, personalized response to every new lead — and follows up automatically until they respond.",
    shortDescription: "Instant response to new leads, with automated follow-up sequences until they engage.",
    longDescription: "When a new lead comes in, Flowra responds within seconds with an AI-personalized message. If they don't reply, Flowra follows up at the right intervals — keeping your business top of mind without manual effort.",
    category: "Sales",
    icon: "Zap",
    color: "#22C55E",
...
const newCustomerWelcome = {
    ...
    heroDescription: "When a new customer joins, Flowra automatically sends a warm welcome message, provides key information about your business, and starts the relationship on the right foot.",
    shortDescription: "Automated welcome sequence for new customers with business info and onboarding.",
    longDescription: "First impressions set the tone for the entire customer relationship. Flowra automatically sends a personalized welcome message when a new customer is created, introduces your business, and provides everything they need to get started.",
    category: "Customer Support",
    icon: "Heart",
    color: "#EC4899",
...
function getProductBySlug(slug) {
    return exports.AUTOMATION_PRODUCTS.find((p) => p.slug === slug);
}
