...
exports.getMockSubmissions = exports.getMockForm = exports.getMockForms = exports.MOCK_SUBMISSIONS = exports.MOCK_FORMS = void 0;
...
const getMockForms = () => Promise.resolve(exports.MOCK_FORMS);
exports.getMockForms = getMockForms;
const getMockForm = (id) => Promise.resolve(exports.MOCK_FORMS.find(f => f.id === id) ?? null);
exports.getMockForm = getMockForm;
const getMockSubmissions = (formId) => Promise.resolve(exports.MOCK_SUBMISSIONS.filter(s => s.formId === formId));
exports.getMockSubmissions = getMockSubmissions;
