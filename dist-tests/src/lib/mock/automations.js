...
exports.getMockAutomation = exports.getMockAutomations = exports.TEMPLATE_AUTOMATIONS = exports.MOCK_AUTOMATIONS = void 0;
const ORG_ID = "mock-org-1";
const now = new Date();
const ago = (days) => new Date(now.getTime() - days * 86400000);
exports.MOCK_AUTOMATIONS = [
    {
...
const getMockAutomations = () => Promise.resolve(exports.MOCK_AUTOMATIONS);
exports.getMockAutomations = getMockAutomations;
const getMockAutomation = (id) => Promise.resolve(exports.MOCK_AUTOMATIONS.find(a => a.id === id) ?? null);
exports.getMockAutomation = getMockAutomation;
